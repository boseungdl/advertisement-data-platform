...
> 데이터 본질(Criteo Attribution Dataset)과 우리 파이프라인이 그걸 어떻게 쪼개 흐르게 하는지는 [docs/SETUP.md — 데이터 본질·구조](../docs/SETUP.md#데이터-본질구조-criteo-attribution-dataset)에 분리. 발표 시 한 슬라이드 소개로 충분, 디테일은 별도 문서.
