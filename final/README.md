...
> 메타코드 Lakehouse 강의 8회차 최종 프로젝트 — **평가 답변 9개 섹션**.
> 작성일: 2026-05-09 (살아있는 문서, Epic 진행하며 갱신).
...
(TBD — C2에서 비용 추정 칸 추가, ADR-007은 Epic 7에서 본문 작성)

---

## 8. 장애·운영 시나리오

(TBD — C2에서 RUNBOOK 형식으로 3건 채울 예정)
...
- 2026-05-10 v2: 운영 절차(디렉토리/AWS/데이터/Bootstrap) 4개 섹션을 [docs/SETUP.md](../docs/SETUP.md)로 분리. 평가 답변만 남김.
