...
> 🟢 **데모와의 차이**: 강의 데모(`iceberg-lakehouse-lab`)는 도메인이 정해지지 않은 generic Iceberg 메달리온 예제. 저는 **광고 도메인으로 좁히고 클릭·노출·전환을 명시**해, §3 메달리온 결정과 §4 Iceberg 가치를 광고 도메인의 실제 운영 어려움(late-arriving conversion)에 맞춰 도출했습니다.
